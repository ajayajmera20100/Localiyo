...
app.post("/feedimage", store.array("images"), (req, res, next) => {
    ...
    // res.send(json(files));
    // res.send(" ya image is not uploaded");
...
app.post("/login", async (req, res) => {
    try {
        ...
        if (useremail.password === password && useremail.isVerified) {
            ...
            // res.send("invalid login credentials ");
            //   res.send( alert('invalid in alert '));
...
app.post("/signup", async (req, res) => {
    ...
    await newUser.save();
        ...
        try{
            ...
            // req.alert('success','Thanks For Registering. Please Check Your Email To Verify Your Account.');
            res.redirect('/login');
            ...
            // req.flash(error,'Something Went Wrong. Please Contact Us At support@localiyo.com For Assistance.');
